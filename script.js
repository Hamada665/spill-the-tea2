...
const blogData = {
    1: {
        ...
        content: `
            <BLOG1_BLOGS.png" style="width:100%; border-radius:15px; margin-bottom:20px;">
    ...
    2: {
        ...
        content: `
            <BLOG2_BLOG.jpg" style="width:100%; border-radius:15px; margin-bottom:20px;">
    ...
    3: {
        ...
        content: `
            <BLOG3_BLOGS.jpg" style="width:100%; border-radius:15px; margin-bottom:20px;">
